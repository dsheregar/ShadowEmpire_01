...
function HitManager(){
	...
	switch (state)
	{
		case STATE_ATTACK:
			...
			{
				//Normal indexes
				RenderHit(attack_indexes[atk_type], x_hitbox, y_hitbox, 5, self, noone, x_scale, y_scale, angle)
			} else
			{
				//Air indexes
		...
		case STATE_ATTACK_DUCK:
			RenderHit(attack_duck_indexes[atk_type], x_hitbox, y_hitbox, 5, self, noone, x_scale, y_scale, angle)
		break
		...
		//Ranjit Combos
		case HEAD_SLAMMER:
			RenderHit(head_slammer_index, x_hitbox, y_hitbox, 10, self, noone, x_scale, y_scale, angle)
		break
		case AERIAL_ROUNDHOUSE:
			RenderHit(aerial_roundhouse_index, x_hitbox, y_hitbox, 10, self, noone, x_scale, y_scale, angle)
		break
